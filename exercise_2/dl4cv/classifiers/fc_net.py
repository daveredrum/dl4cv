...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        a_1, a_1_cache = affine_forward(X, self.params['W1'], self.params['b1'])
        relu, relu_cache = relu_forward(a_1)
        a_2, a_2_cache = affine_forward(relu, self.params['W2'], self.params['b2'])
        scores = a_2
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
